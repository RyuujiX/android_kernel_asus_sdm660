...
#define ISUBUNTU1404
#elif (LINUX_VERSION_CODE < KERNEL_VERSION(4, 5, 0) || LINUX_VERSION_CODE >= KERNEL_VERSION(4, 4, 256)) && LINUX_VERSION_CODE >= KERNEL_VERSION(4, 4, 0)
#define ISUBUNTU1604
